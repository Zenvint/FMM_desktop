...
const FeeSettings = () => {
  ...
  const [newSalarymonth, { isLoading: isNSMLoading, isSuccess:isNSMSuccess, isError:isNSMError, error:NSMerror }] =
  ...
  const handleStartNewFeeYear = () => {
    showConfirmation("Are you sure you want to perform this action?", startNewFeeYear);
  };

  const handleStartNewSalaryMonth = () => {
    showConfirmation("Are you sure you want to perform this action?", startNewSalaryMonth);
  };
        ...
        <div className="box">
          ...
          <fieldset>
            ...
            >
              ...
              <AddBtn btnName={"Start"} handleEdit={handleStartNewSalaryMonth} />
            </Box>
